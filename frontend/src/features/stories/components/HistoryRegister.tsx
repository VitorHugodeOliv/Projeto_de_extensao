...
import { apiHistorias } from "@lib/api/api";
import api from "@lib/api/api-axios";
import { useAuth } from "@lib/store/auth-store";
import { uploadMidias } from "@lib/utils/upload-midias";
import { validarArquivos } from "@lib/utils/validar-arquivos";
import "../styles/history-register.css";
